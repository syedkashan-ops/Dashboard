...
class ExcelWriter:
    ...
    def create_all(self) -> None:
        ...
        # Ensure every dark-filled column/header cell uses white font.
        for sheet in self.wb.worksheets:
            for row_cells in sheet.iter_rows():
                for cell in row_cells:
                    fill_rgb = getattr(getattr(cell.fill, "fgColor", None), "rgb", None)
                    if fill_rgb and str(fill_rgb).upper().endswith("1F4E78"):
                        cell.font = Font(name=cell.font.name or "Calibri", size=cell.font.sz or 11,
                                         bold=cell.font.bold, italic=cell.font.italic,
                                         underline=cell.font.underline, color="FFFFFF")
    ...
    def save(self) -> Path:
        ...
        print("Saving Excel workbook. Please wait...")
        self._finalize_dashboard_formatting()
        self._apply_requested_heading_text()
        self._apply_requested_display_formats()
        self._remove_circular_formulas()
